    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Calendário de Estudo</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">Veja suas próximas revisões e planeje seus estudos.</p>
          </div>
          <button
